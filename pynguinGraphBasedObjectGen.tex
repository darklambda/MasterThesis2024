...
\begin{figure}[htb]
  ...
  \caption{Branch coverage evolution for those modules that obtained the worst Cohen's D effect size value in each algorithm.}\label{fig:worst}
\end{figure}

\begin{figure}[htb]
  \centering
  \includegraphics[width=0.9\textwidth]{Figures/Results/bestES.jpg}
  \caption{Branch coverage evolution for those modules that obtained the best Cohen's D effect size value in each algorithm.}\label{fig:best}
\end{figure}
...
The obtained answer for the second research question develops in the same direction as the discussion of the first research question, implying that the majority of Python modules in the testing set do not include type information and the necessity for complex object inputs.
