...
\begin{summary}{RQ1: Performance of GBOS over Pynguin}
  The results of the proposed GBOS extension for Pynguin \textbf{does not show} an improvement compared to Pynguin itself while being evaluated over previously studied modules, similarly as EvoObj outperformed EvoSuite. 
\end{summary}
